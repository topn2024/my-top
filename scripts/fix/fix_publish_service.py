...
def main():
    ...
    # 上传文件
    sftp = ssh.open_sftp()
    local_file = PROJECT_ROOT / "backend" / "services" / "publish_service.py"
    remote_file = f"{DEPLOY_DIR}/backend/services/publish_service.py"
