...
SET SERVER_USER=u_topn
SET SERVER_IP=39.105.12.124
SET SERVER_PATH=/data/TOP_N
...
REM 上传 analysis_prompt_service.py
...
REM 上传 article_prompt_service.py
